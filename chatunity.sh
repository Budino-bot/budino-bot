...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/Budino-bot/budino-bot\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/budino-bot/budino-bot.git
...
menu_aiuto() {
    #printf "${v1}[${b}++${v1}]${v} budino-botD${b}: "
	read opzione
	case $opzione in
            01|1)
...
echo -e "\033[01;32m\033[01Avviando budino-bot..!!\nStarting budino-bot!!\n\033[0m"
npm start