...
mobile: MethodMobile, 
browser: opcion == '1' ? ['𝐁𝐮𝐝𝐢𝐧𝐨-𝐁𝐨𝐭', 'Safari', '2.0.0'] : methodCodeQR ? ['𝐁𝐮𝐝𝐢𝐧𝐨-𝐁𝐨𝐭', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '110.0.5585.95'],
auth: {
creds: state.creds,
...
setInterval(async () => {
  ...
  const bio = `𝐁𝐮𝐝𝐢𝐧𝐨-𝐁𝐨𝐭 𝐨𝐧𝐥𝐢𝐧𝐞 𝐝𝐚 ${uptime} `
